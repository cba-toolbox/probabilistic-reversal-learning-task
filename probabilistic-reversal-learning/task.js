...
// ブロックの試行数とs1の報酬確率
const trial_num = [40, 40];
const prob_s1 = [0.2, 0.8];
  ...
  timeline: [
    // **選択画面**
    {
      ...
      <button id='left' style='border: none; background: none; position: absolute; left: 0;'>
        <img src='probabilistic-reversal-learning/stimuli/${jsPsych.evaluateTimelineVariable('left_img')}' width='300px'/>
      </button>
      ...
      <button id='right' style='border: none; background: none; position: absolute; right: 0;'>
        <img src='probabilistic-reversal-learning/stimuli/${jsPsych.evaluateTimelineVariable('right_img')}' width='300px'/>
      </button>
    　</div>`;
      },
    ...
    }, // **選択画像の変更 (500ms)**
    {
      ...
      stimulus: function() {
        ...
        return  `
          <div style='display: flex; justify-content: space-between; align-items: center; width: 800px; margin: auto; position: relative;'>
          <button id='left' style='border: none; background: none; position: absolute; left: 0;'>
          <img src='probabilistic-reversal-learning/stimuli/${updated_left_img}' width='300px'/>
          </button>
          <div style='position: absolute; left: 50%; transform: translateX(-50%); font-size: 32px; font-weight: bold;'>
          ＋
          </div>
          <button id='right' style='border: none; background: none; position: absolute; right: 0;'>
          <img src='probabilistic-reversal-learning/stimuli/${updated_right_img}' width='300px'/>
          </button>
    　    </div>`;
      },
      trial_duration: 500,
    ...
    },// **報酬 or 罰の提示 (1000ms)**
    {
      ...
      stimulus: function() {
        ...
        return `<img src='probabilistic-reversal-learning/stimuli/${reward_given}' width='350px'/>`;
      },
      trial_duration: 1000,
      response_ends_trial: false
    },// **固視点の提示 (500~1000ms)**
...
const instruction = {
  ...
  stimulus: `
    <div style="text-align: center;">
      <img src="probabilistic-reversal-learning/stimuli/rl_instruction.svg" width="800px">
    </div>`,
  choices: ['ArrowRight'], 
};
